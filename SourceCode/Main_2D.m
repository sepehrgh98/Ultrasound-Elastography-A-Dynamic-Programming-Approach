...
for colIdx = 1:imWidth
    ...
    C(1, stratIndexDeltaAx:end, stratIndexDeltaLat:end) = delta2d(1,colIdx, da(stratIndexDeltaAx:end), dl(stratIndexDeltaLat:end), g, g_prime);
    ...
    for rowIdx = 2:imHight
        ...
        for axDisIdx = startADis:endADis
            ...
            for latDisIdx = startLDis:endLDis
                ...
                minValue = min(a(:));
                [minAIdx,minLIdx] = find(a==minValue);
    ...
    [minACIdx,minLCIdx] = find(lastCost==minCost);
